...
A. 인천대학교 내규에 따릅니다.    
통상 이수학점에 지장이 될 수 있는 4학년 또는 필수과목에 한해서 증원이 가능한걸로 압니다(22년 9월 이후 기준).    
...
A. Question and Talk의 **`6가지 채널`**을 활용하며 확인하는대로 답변 드립니다.    
...
공휴일을 대신하여 보강을 진행해야 하면, 여러분들과 **`협의 하에 별도 일정을 잡아 보강을 하거나 별도 동영상로 대체`**하겠습니다.    

**Q. Zoom 링크는 언제 전달해 주시나요?**

A. Zoom 링크는 미리 생성해도 변경될 가능성이 높고 여러분들도 수업 전 다른 일정이 있듯이,    
...
첫번째, 화상수업 녹화가 되기고 하고 안되기도 하고 해고 **`환경상 오류`**가 발생될 수 있습니다.    
두번째, 화상강의 공유는 **`초상권 및 개인정보 문제로 원칙적으로 불법`**입니다.    
...
A. 동영상은 보통 미리 업로드 되어 있지만, 화상강의는 수업후 바로 업로드는 어렵습니다.     
수업 종료 후 별도 인코딩도 해야 하고 상태나 법적이슈도 체크해야하기 때문입니다.    
즉, 동영상은 빠르게 업로드가 되더라도 화상수업 영상은 최대한 수업 후 빠르게 업로드 하려고 합니다.   
...
설치 동영상에서 아나콘다 설치 후 별도 설치 방법을 제시하고 있습니다.    
만약, 별도 설치 후에도 나타나지 않는다면 Jupyter Notebook 웹페이지와 Notebook 서버를 모두 종료하고 **`다시 설치 및 실행`**해 보시기 바랍니다.    
...
이것도 어렵다 싶으면.. 브라우저 페이지를 모두 **`스크롤 캡쳐를 해서 pdf로 변환하는 방법`**이 가장 쉬울 것입니다.    
